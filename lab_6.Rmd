...
[A more comprehensive explanation of differences between groups... actually means, data spread, effect size]... there os no significant difference (t(df) = t-statistic value, p = ).
...
The medians of group A  (M = 22.4 g) amd group B (M = 31.2 g) did not differ significantly (Mann Whitney U, ...).

## Simple linear regression

Two variables that you are trying to understand the relationship between, and you think that a linear relationship makes sense.
